...
import com.lv.dialog.BottomPopupWindow;
import com.lv.dialog.CustomDialog;
import com.lv.dialog.EditDialog;
import com.lv.dialog.EnsureDialog;
import com.lv.qm.R;

import java.util.List;

/**
 * 作者：created by albert on 2019/4/12 16:53
...
public class CustomDialogActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showEditDialog() {
        ...
        dialog.setPositiveButton("确定", new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CustomDialogActivity.this, "输入内容为：" + msg, Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
        dialog.show();
    ...
    private void showSDCustomEditDialog() {
        final CustomDialog customDialog = new CustomDialog(this,
                ...
                new int[]{R.id.btn_cancel, R.id.btn_sure, R.id.edt_content},
                0,
                false,
                false,
                Gravity.CENTER);
